 ...
 * @author Gobishanth
 */
@WebServlet(name = "SubUp", urlPatterns = {"/SubUp"})
public class SubUp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SubUp</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SubUp at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
     ...
     private void listCategory(HttpServletRequest request, HttpServletResponse response)
       ...
       // BookModel book=new BookModel();
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("SubUp.jsp");
