 ...
 * @author Gobishanth
 */
@WebServlet(name = "UpdateCalling", urlPatterns = {"/UpdateCalling"})
public class UpdateCalling extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateCalling</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateCalling at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        //processRequest(request, response);
          ...
          book.setNoOfPages(request.getParameter("noOfPages"));
           ...
           try {
                 ...
                 Logger.getLogger(UpdateCalling.class.getName()).log(Level.SEVERE, null, ex);
             }
    }
