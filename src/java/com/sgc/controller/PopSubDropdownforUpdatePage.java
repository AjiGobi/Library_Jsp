...
public class PopSubDropdownforUpdatePage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String yearOfPublishing = request.getParameter("yearOfPublishing");
         String lastPrintedYear = request.getParameter("lastPrintedYear");
        ...
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("UpdateController");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("subClassification", categoryId);
    }
